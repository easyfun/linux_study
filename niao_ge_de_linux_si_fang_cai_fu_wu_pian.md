...
18.4.1启动用户的个人网站<br/>
/etc/httpd/conf/httpd.conf 配置修改<br/>
主目录/ 权限修改<br/>
主目录/public_html/ 权限修改<br/>
SELINUX 关闭，打开的配置<br/>
    getenforce<br/>
    setenforce 0<br/>

18.4.2启动某个目录的CGI程序执行权限<br/>

18.4.3找不到网页时的显示信息通知<br/>
Web服务器响应码意义<br/>
100~199   一些基本信息<br/>
200~299   客户端的请求已成功实现<br/>
300~399   客户端的请求需要其它额外的操作<br/>
400~499   客户端的请求没法完成（例如找不到网页）<br/>
500~599   服务端错误（例如配置错误）<br/>

18.4.4浏览权限的设置操作<br/>

18.4.5主机状态说明网页<br/>
mod_statusm模块，查看Apache服务器运行状态<br/>

18.4.6 .htaccess与认证网页设置<br/>
